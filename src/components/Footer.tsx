      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <div className="flex space-x-4">
            <a 
              href="https://www.instagram.com/cffresin/" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-resin-blue hover:text-resin-blue-light transition-colors"
            ...
            <a 
              href="https://www.tiktok.com/@cffresin" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-resin-blue hover:text-resin-blue-light transition-colors"
            ...
            <a 
              href="https://www.facebook.com/people/CFF-Resin/" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-resin-blue hover:text-resin-blue-light transition-colors"
