      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm">
            <Link href="/" className="hover:text-resin-blue-light transition-colors">Home</Link>
        ...
        {open && (
          <div className="md:hidden py-2 border-t border-resin-blue/20">
            <div className="flex flex-col gap-2 py-2">
              <Link href="/" className="px-2 py-2 rounded hover:bg-white/10 transition-colors" onClick={() => setOpen(false)}>Home</Link>
